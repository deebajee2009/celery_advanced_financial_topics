...
## About
توسعه پروژه های مالی مانند سامانه های پرداخت، صرافی آنلاین و خرید و فروش آنلاین طلا نیازمند بکارگیری بهترین استانداردهای به منظور تضمین محافظت از امنیت داده ها، پایداری و عملکرد درست سامانه، consistency و integrity داده ها می باشد. یکی از مهم ترین اجزا هر پروژه django بخش Async Task Queue می باشد که شاخص ترین آن Celery می باشد.
در این ریپو تلاش کرده ام مجموعه ای از بهترین نکات سلری که می بایست در پروژه های مالی پیاده سازی شوند را جمع آوری کنم.
